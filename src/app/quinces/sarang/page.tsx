...
const ModalOpening = ({
  ...
  return (
    <Modal
      ...
      className="rounded-none rotate-6"
    >
      <ModalContent
        style={{ backgroundColor: "#ba60f0" }}
      ...
      >
        {(onClose) => (
          <>
            ...
            <ModalBody>
              <motion.p
                className={`${pinyion.className} text-center text-5xl text-slate-50 z-20 my-5`}
                style={{
            ...
            <ModalFooter className="flex justify-center mt-10">
              <motion.div variants={animationButton01}
                initial="hidden"
                whileInView="visible">
                <Button
                  color="secondary"
