...
export default function Main() {
  ...
  return (
    <div
      className="max-w-3xl m-auto shadow-large bg-[url('/img/quinces/sarang/background-main.png')] bg-center bg-cover bg-fixed"
    ...
    >
      {open && (
        ...
        >
          ...
          <AudioControl />
          <motion.div
            className="bg-[url('/img/quinces/sarang/header-02-1.png')] bg-cover bg-bottom absolute inset-0 z-0"
