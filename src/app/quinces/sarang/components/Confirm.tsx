...
import { aref, notoSans, oswald, playFair, rouge } from "./Fonts";
      ...
      >
        ...
        >
          <CardBody className="flex items-center justify-center flex-col overflow-clip">
            ...
            <motion.p
              className={`${aref.className} text-center mt-5 pb-2 px-5 max-w-md custom-text-purple`}
              variants={animation03}
              initial="hidden"
              whileInView="visible"
            >
              I hope you can come share with us this unforgettable day.
            </motion.p>
            <motion.p
              className={`${aref.className} text-center p-2 custom-text-purple`}
              variants={animation03}
              initial="hidden"
              whileInView="visible"
            >
            ...
            >
              <Button
                variant="bordered"
                color="secondary"
                onClick={() => window.open("https://wa.link/a3prjw", "_blank")}
                className="w-60"
              >
            ...
            >
              <Button
                variant="bordered"
                color="secondary"
                onClick={() => window.open("tel:9565453386", "_blank")}
                className="w-60"
              >
