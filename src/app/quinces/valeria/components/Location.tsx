...
function Location() {
  ...
  return (
    <>
      <section className="h-screen text-zinc-700 flex flex-col items-center justify-center bg-[url('/img/quinces/valeria/white-bg.jpg')] bg-center bg-cover overflow-clip">
        <motion.p
          className={`${mea.className} text-5xl mb-10 text-sky-800`}
        ...
        <motion.span
          className={`${gran.className} mb-10 text-5xl bg-gray-200/50 font-medium me-2 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300 flex items-center justify-center gap-1`}
        ...
        <motion.h2
          className={`${glass.className} text-center text-2xl`}
        ...
        <motion.p
          className={`${luxurious.className}  mt-3 text-sm text-center`}
