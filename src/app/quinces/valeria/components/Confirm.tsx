...
function Confirm() {
  return (
    <section className="h-screen flex flex-col items-center justify-center overflow-clip bg-gradient-to-t from-blue-950 via-blue-900 to-blue-950 relative">
      <motion.h1
        className={`${mea.className} text-6xl text-metallic text-center py-7 z-20`}
      ...
      <motion.p
        className={`${luxurious.className} text-lg z-20 text-center mt-3 text-zinc-300 max-w-md px-10`}
      ...
      <motion.p
        className={`${luxurious.className} text-lg z-20 text-center mt-5 text-zinc-300 max-w-md px-10`}
