...
import { dancing, quickSand, titillium } from "./Fonts";
          ...
          <>
            ...
            <ModalBody>
              <div className="flex flex-col ">
                ...
                <Code>Laurence Bermudez Davila</Code>{" "}
...
export default function Gifts() {
  ...
  return (
    <>
      <section className="h-screen flex flex-col items-center justify-center bg-[url('/img/quinces/no-name/background-confirm.jpg')] bg-center bg-cover relative">
        <motion.svg
        ...
        <motion.div
          ...
          variants={gifts.icons01}
          initial="hidden"
          whileInView="visible"
        >
          <div className="flex items-center justify-center flex-col w-20 z-20">
            <Avatar
          ...
          <div className="flex items-center justify-center flex-col w-20 z-20">
            <Avatar
              ...
              isBordered
              onClick={() => openLink("https://www.amazon.com.mx/registries")}
            />
            <Link
              color="warning"
              className="font-semibold mt-1"
