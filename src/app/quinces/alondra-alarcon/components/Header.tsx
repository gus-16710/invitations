...
//     >
//       <motion.h2
//         className={`${playFair.className} text-2xl flex items-center text-yellow-600 z-20 mt-2`}
//         variants={header.text02}
//         initial="hidden"
//         whileInView="visible"
//       >
//         MIS <span className="text-5xl">XV</span> AÑOS
//       </motion.h2>
//       <div className="relative w-full h-96 flex items-center justify-center overflow-clip mt-2">
//         <motion.div
//           className="bg-[url('/img/quinces/alondra-alarcon/round-frame-5.png')] bg-contain bg-no-repeat bg-center absolute w-full h-full opacity-80"
...
//           <motion.span
//             className="border-y-1 border-y-yellow-700 py-2 w-28 text-center text-yellow-800"
...
//           </motion.span>
//           <motion.span
//             className="text-yellow-700 text-5xl px-2 pb-2"
...
//           </motion.span>
//           <motion.span
//             className="border-y-1 border-y-amber-800 py-2 w-28 text-center text-yellow-700"
//             style={{ letterSpacing: "2px" }}
  ...
  return (
    ...
    >
      ...
      <div className={`${playFair.className} flex items-center flex-col mt-5 text-yellow-800`}>
        <motion.span
          className="px-2 pb-2 text-sm tracking-widest"
          variants={header.month}
          initial="hidden"
          whileInView="visible"
        >
        ...
        <div className="flex items-center gap-2">
          <motion.div
            className="w-8 h-px bg-yellow-600"
            initial={{ scaleX: 0 }}
          ...
          <p className="flex items-center">
            <motion.span
              className="border-y border-y-yellow-700 py-2 px-3 text-center text-yellow-800 text-sm"
              style={{ letterSpacing: "2px" }}
              variants={header.day}
              initial="hidden"
              whileInView="visible"
            ...
            <motion.span
              className="text-yellow-700 text-6xl px-4 pb-2 font-bold"
              variants={header.dayNumber}
              initial="hidden"
              whileInView="visible"
              style={{
            ...
            <motion.span
              className="border-y border-y-amber-800 py-2 px-3 text-center text-yellow-700 text-sm"
              style={{ letterSpacing: "2px" }}
              variants={header.time}
              initial="hidden"
              whileInView="visible"
        ...
        <motion.p
          className={`${playFair.className} text-3xl font-bold mt-2 tracking-wider`}
          style={{
            color: '#d97706',
