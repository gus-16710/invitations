...
import { greatVibes, mea, quickSand } from "./components/Fonts";
import { animation03 } from "./components/Animations";
        ...
        {(onClose) => (
          <>
            <ModalBody className="relative overflow-clip">
              <p
                className="flex items-center z-20 justify-center mt-5"
                style={{ color: "#513704" }}
              >
                <motion.label
                ...
                <motion.label
                  className={`text-5xl ${greatVibes.className} text-golden p-2`}
                  variants={{
              ...
              <motion.p
                className={`text-xl ${quickSand.className} text-center`}
                variants={{
                  hidden: { y: -100, opacity: 0 },
                  visible: {
                    y: 0,
