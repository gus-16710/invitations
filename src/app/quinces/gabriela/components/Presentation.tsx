      ...
      >
        <CardBody className="flex items-center justify-center flex-col">
          ...
          <motion.p
            ...
            style={{ color: "#513704" }}
          >            
            Esta noche, el brillo, la emoción y la magia se unen para celebrar
            los XV años de Gabriela Yeyetzi, un momento único que marca el
            inicio de una nueva etapa llena de sueños y aventuras.
          </motion.p>
        </CardBody>
      </Card>
    </section>
