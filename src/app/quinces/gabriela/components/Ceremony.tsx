...
const MapCeremony = () => (
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3760.5037035354585!2d-96.92704892437469!3d19.519976881778152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85db2df9de8deebf%3A0xed4891e3277f5c01!2sBas%C3%ADlica%20de%20Guadalupe!5e0!3m2!1ses!2smx!4v1742347566879!5m2!1ses!2smx"
    height="450"
    style={{ border: "0" }}
    allowFullScreen
    loading="lazy"
        ...
        >
          <CardBody className="flex items-center justify-center flex-col overflow-clip">
              ...
              >
                {!flipped ? (
                  <Avatar
                    isBordered
                    color="warning"
                    src="/img/quinces/gabriela/ceremonia.jpg"
                  ...
                  <Avatar
                    isBordered
                    color="warning"
                    src="/img/quinces/gabriela/ceremonia-02.jpg"
                    className="h-36 w-36 mt-5 shadow-lg"
                  />
                )}
              </motion.div>
            ...
            <motion.p
              ...
              style={{ color: "#513704" }}
            >
              Basílica de Guadalupe <br /> El Dique
            </motion.p>
            <motion.p
              ...
              style={{ color: "#513704" }}
            >
              C. Unión, Felipe Carrillo Puerto, 91080 Xalapa-Enríquez, Ver.
            </motion.p>
            <motion.div
              variants={animation04}
              initial="hidden"
