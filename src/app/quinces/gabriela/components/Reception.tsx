...
import { aref, greatVibes, pinyion, playFair, rajdhani } from "./Fonts";
import {
  animation01,
  animation03,
  animation04,
...
const MapSalon = () => (
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3760.845697294844!2d-96.85060207838674!3d19.5052733286973!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85db3393fb897caf%3A0x1cbe14a5d1ad26ee!2sRancho%20San%20Lorenzo!5e0!3m2!1ses!2smx!4v1742349553705!5m2!1ses!2smx"
    height="450"
    style={{ border: "0" }}
    allowFullScreen
    loading="lazy"
        ...
        >
          <CardBody className="flex items-center justify-center flex-col">
              ...
              >
                {!flipped ? (
                  <Avatar
                    isBordered
                    color="warning"
                    src="/img/quinces/gabriela/recepcion.jpg"
                  ...
                  <Avatar
                    isBordered
                    color="warning"
                    src="/img/quinces/gabriela/recepcion-04.jpg"
                    className="h-36 w-36 mt-5 shadow-lg"
                  />
                )}
              </motion.div>
            ...
            <motion.p
              ...
              style={{ color: "#513704" }}
            >
              Carretera Xalapa, Veracruz KM 5. 91643 Emiliano Zapata, Ver.
            </motion.p>
            <motion.div
              variants={animation04}
              initial="hidden"
