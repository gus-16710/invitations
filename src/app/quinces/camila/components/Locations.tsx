...
export default function Locations() {
  return (
    ...
    >
      ...
      <button
        type="button"
        className="mt-5 text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
      >
        Ubicación
      </button>

      <Divider orientation="vertical" className="h-14 mt-4 mb-7 bg-pink-700" />
