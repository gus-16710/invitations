...
import { dancing, lora, playFair, rivage, whisper } from "./Fonts";
...
export default function Header() {
  return (
    <section className="h-screen relative flex justify-center items-center flex-col">
      ...
      >
        <motion.div
          className="w-24 flex flex-col items-center border-r-1 border-zinc-500"
        ...
        <motion.div
          className="w-24 flex flex-col items-center border-l-1 border-zinc-500"
