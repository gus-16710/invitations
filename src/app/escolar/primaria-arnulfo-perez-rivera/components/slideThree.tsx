...
export default function SlideThree() {
  ...
  return (
    ...
    >
      <motion.div
        className="flex flex-col justify-center items-center text-blue-950"
        initial="hidden"
        whileInView="show"
        variants={container}
      >
        ...
        >
          <motion.p
            className={`${greatVibes.className} text-4xl bg-blue-950 rounded-full w-12 h-12 text-zinc-50 flex justify-center items-center shadow-2xl`}
            whileHover={{
              scale: 1.1,
              rotate: [0, 10, -10, 0],
