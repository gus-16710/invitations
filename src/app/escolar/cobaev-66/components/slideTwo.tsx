...
import { dancing, luxurious, mea, urbanist } from "./Fonts";
...
export default function SlideTwo() {
  ...
  return (
    <>
      ...
      >
        <h1 className={`${dancing.className} text-zinc-50 text-6xl`}>Ubicación</h1>
        <Avatar
          isBordered
          color="warning"
          src="/img/escolar/cobaev-66/auditorio.jpg"
          className="h-40 w-40 my-5 shadow-lg"
          radius="none"
        />

        <span className="flex items-center justify-center gap-1 bg-zinc-100 text-blue-900 text-2xl font-medium me-2 px-2.5 py-0.5 rounded-full border border-blue-400 mb-5">
          <IoMdTime /> 12:30 HRS
        </span>
