  ...
  return (
    ...
    >
      {/* <motion.svg
        ...
        xmlSpace="preserve"
        className="fill-zinc-700 -rotate-12"
      ...
      {/* Mensaje principal */}
      <motion.p
        className="mx-10 text-center mt-5 text-lg"
        initial={{ y: 30, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.3 }}
      >
        Nunca pares, nunca te conformes, hasta que lo bueno sea lo mejor y lo
        mejor sea excelente. Porque cada paso que das con pasión y disciplina te
        acerca a tus sueños. Cree en ti, trabaja con constancia y recuerda
        siempre que el verdadero éxito está en nunca dejar de aprender.
      </motion.p>
    </section>
  );
}
