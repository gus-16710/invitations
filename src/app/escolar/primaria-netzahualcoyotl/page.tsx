      ...
      <ModalContent>
        {(onClose) => (
          <>
            ...
            <ModalBody>
              <h2
                className={`${nobile.className} text-zinc-800 text-lg text-center`}
              >
              ...
              <h2 className={`${nobile.className} text-zinc-800 text-center`}>
            ...
            <ModalFooter className="flex justify-center">
              <button
                type="button"
                className="flex items-center gap-2 text-gray-100 hover:text-white border border-gray-400 bg-zinc-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2 text-center me-2"
                onClick={() => {
                  setOpen(true);
                  onClose();
                }}
...
export default function School() {
  ...
  return (
    <main className="bg-[url('/img/escolar/primaria-netzahualcoyotl/background01.jpg')] bg-center bg-cover h-screen">
      {open && (
