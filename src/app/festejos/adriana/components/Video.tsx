...
const list = {
  visible: {
    ...
    transition: {      
      when: "beforeChildren",
      staggerChildren: 0.5, // Aumenté un poco el stagger para palabras
    },
  },
  hidden: {
    opacity: 0,
...
export default function Video() {
  const text = `Queridos clientes y amigos: Gracias por confiar en nosotros, por permitirnos ser parte de sus momentos especiales, de sus cambios, de sus antojos y de sus sonrisas.`;
  const text2 = `En Salón de Belleza Adriana y Un Rinconcito de Sabor, seguiremos atendiendo con amor, dedicación y el deseo sincero de hacerlos sentir bien, por dentro y por fuera.`;
  const text3 = `Con cariño, Beatriz Adriana.`;
  ...
  return (
    ...
    >
      ...
      >
        <source src="/img/festejos/adriana/roscavideo.mp4" type="video/mp4" />
        Tu navegador no soporta videos HTML5.
      </video>

      <div className="absolute top-0 left-0 w-full h-full z-5 bg-gradient-to-t from-zinc-950/100 to-transparent"></div>
      ...
      <motion.p
        className={`${quickSand.className} text-center mt-10 pb-2 px-10 max-w-md text-white z-10`}
      ...
      <motion.p
        className={`${quickSand.className} text-center pb-2 px-10 max-w-md text-white z-10`}
        style={{ textShadow: "0px 1px 1px rgb(0,0,0)" }}
        variants={list2}
        initial="hidden"
        whileInView="visible"
      ...
      <motion.p
        className={`${quickSand.className} mt-5 text-center pb-2 px-10 max-w-md text-white z-10`}
        style={{ textShadow: "0px 1px 1px rgb(0,0,0)" }}
        variants={list3}
        initial="hidden"
        whileInView="visible"
