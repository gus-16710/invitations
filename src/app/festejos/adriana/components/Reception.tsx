        ...
        {(onClose) => (
          <>
            ...
            <ModalBody className="relative flex justify-center items-center">
              <iframe              
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1878.750392889003!2d-96.98674501546364!3d19.648629164220164!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85db25001acf039b%3A0xd77ce7db89b0bf6d!2sAdriana%20Beauty%20Salon!5e0!3m2!1ses!2smx!4v1767741907872!5m2!1ses!2smx"
                height="450"
                style={{ border: "0" }}
                allowFullScreen
                loading="lazy"
...
export default function Reception() {
  ...
  return (
    <>
      <section
        className="flex justify-center items-center flex-col pt-20 pb-20 bg-[url('/img/festejos/adriana/roscamesa.jpg')] bg-cover bg-center relative"
        style={{ height: "100svh" }}
      >
        <motion.h1
