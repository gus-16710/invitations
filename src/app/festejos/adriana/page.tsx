...
const ModalOpening = ({
  ...
  return (
    ...
    >
      <ModalContent className="bg-[url('/img/festejos/adriana/reyes.jpg')] bg-cover bg-center overflow-clip">
        {(onClose) => (
          <>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center z-30">
                ...
                <Flowbite>
                  ...
                  >
                    <div>
                      <motion.div
                        className="z-30 flex justify-center items-center gap-2 relative"
                        initial="hidden"
                      ...
                      >
                        ...
                        >
                          <Image
                            width={200}
                            height={200}
                            alt="Adriana Salon de Belleza"
                            src="/img/festejos/adriana/adrianabsc.png"
                          />
                        </motion.div>
                      </motion.div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <Image
                            width={320}
                            height={320}
                            alt="Rinconcito de Sabor"
                            src="/img/festejos/adriana/rinconcito.png"
                          />
                        </motion.div>
                      </motion.div>
                    </div>
                ...
                <div className="z-30 mb-10 mt-5">
                  ...
                  <motion.p
                    className={`text-2xl ${great.className} text-white text-2xl font-bold tracking-wider drop-shadow-lg text-center mt-5`}
                    variants={list2}
                    initial="hidden"
                    animate="visible"
                  >
...
export default function JYR() {
  ...
  return (
    <main className={`background-class ${open ? "" : "h-screen"}`}>
      {open && (
        <div className="max-w-3xl m-auto bg-[url('/img/festejos/adriana/rosca.jpg')] bg-cover bg-center shadow-large relative">
          <Splide
            aria-label="J & R"
            options={{
              rewind: true,
