        ...
        {(onClose) => (
          <>
            ...
            <ModalBody className="relative flex justify-center items-center">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d939.3754584827221!2d-96.98649083016358!3d19.6485844!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85db25d9c1134349%3A0xc5793b9ff2c4f6b2!2sLa%20Sant%C3%ADsima%20Trinidad!5e0!3m2!1ses!2smx!4v1751504149592!5m2!1ses!2smx"
                height="100%"
                style={{ border: "0" }}
                allowFullScreen
                loading="lazy"
      ...
      >
        <CardBody className="flex items-center justify-center flex-col overflow-clip">
          ...
          <motion.p
            ...
            whileInView="visible"
          >
            Calle Principal S/N Tengonapa, 91353, Veracruz.
          </motion.p>
          ...
          <img
            ...
            height={100}
            alt="enano3"
            src="/img/festejos/megan-guadalupe/enano3.png"
