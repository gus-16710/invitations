...
import { animate03, animate04, animate05, animate06, animate07, animation01, animation03, animation06 } from "./Animations";
    ...
    >
      ...
      >
        <CardBody className="flex items-center justify-center flex-col overflow-clip">
          <motion.h2
            className={`text-5xl mb-5 text-amber-400`}
            style={{
              fontFamily: "rumble",
          ...
          >
            ...
            <br />
            Mariel Jiménez Santiago
          </motion.p>

          <motion.div
            className={`rounded-full w-12 h-12 m-10 flex justify-center items-center shadow-xl bg-red-600`}            
            variants={animate05}
            initial="hidden"
            whileInView="visible"
          >
