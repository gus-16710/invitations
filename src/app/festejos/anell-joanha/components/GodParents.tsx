    ...
    >
      ...
      >
        <CardBody className="flex items-center justify-center flex-col overflow-clip">
          <motion.h2
            className={`text-5xl mb-5 text-purple-950`}
            style={{
              fontFamily: "rumble",
            }}
            variants={animate03}
          ...
          <motion.p
            ...
            whileInView="visible"
          >
            Dulce Ma. Armenta Herrera
            <br />
            Jorge Sánchez Murrieta
          </motion.p>

          <motion.div
            className={`rounded-full w-12 h-12 m-10 flex justify-center items-center shadow-xl`}
          ...
          <motion.p
            ...
            whileInView="visible"
          >
            Claudia Nakazona Peña
            <br />
            Fernando Roberto Soriano Villalaz
          </motion.p>
