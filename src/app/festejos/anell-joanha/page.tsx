            ...
            <ModalBody>
              ...
              >
                <CardBody className="flex items-center justify-center flex-col overflow-clip">
                  <motion.div
                    className="mt-4 custom-text-purple"
                    variants={animate01}
                    initial="hidden"
                    whileInView="visible"
                  >
                    ...
                    <p className={`${notoSerif.className} text-center text-lg`}>
                      Sábado <br /> 01 de Noviembre 2025
                    </p>
                  </motion.div>
                </CardBody>
              </Card>
...
export default function Anell() {
  ...
  return (
    <main className="bg-[url('/img/festejos/anell-joanha/17895799_5916770.jpg')] bg-center bg-cover bg-fixed h-screen">
      {open && <Main />}
      <ModalOpening
        isOpen={isOpen}
        onOpenChange={onOpenChange}
