...
export default function Counter() {
  ...
  const countDownClock = () => {
    const countDownDate: any = new Date("Dec 11, 2025 12:00:00");
  ...
  return (
    <>
      ...
      <motion.div
        className={`${playfair.className} mb-3 mt-5 pb-3 text-gray-900 custom-shadow flex items-baseline justify-center border-1 border-black`}
      ...
      >
        <Image
          alt="Wedding"
          src="/img/bodas/vanessa-susana/image07.jpeg"
          width="100%"
