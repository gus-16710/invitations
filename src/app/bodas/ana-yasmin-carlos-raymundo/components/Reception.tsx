      ...
      <ModalContent>
        {(onClose) => (
          <>
            ...
            <ModalBody>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6327.557933272666!2d-96.9241889892122!3d19.438811608511234!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c4cd487c7125f3%3A0x7c8e649acefa16d!2sSal%C3%B3n%20Campestre%20Las%20Fuentes!5e0!3m2!1ses!2smx!4v1727914576038!5m2!1ses!2smx"
                height="450"
                style={{ border: "0" }}
                allowFullScreen
                loading="lazy"
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          className={`${greatVibes.className} mt-5 text-center text-gray-900 text-6xl`}
        ...
        <motion.p
          ...
          viewport={{ once: false }}
        >
          Av Construcción 67, 91607. Localidad El Grande, Coatepec, Ver.
        </motion.p>
