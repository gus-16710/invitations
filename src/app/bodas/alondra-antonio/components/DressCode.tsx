  ...
  return (
    ...
    >
      ...
      >
        {!flipped ? (
          <div
            className="rounded-full bg-pink-700 flex items-center justify-center p-1 overflow-clip"
            style={{ width: "150px", height: "150px" }}
          >
            <div
              className="rounded-full border-3 border-yellow-400 border-dotted flex justify-center items-center"
          ...
          <div
            className="rounded-full bg-green-600 flex items-center justify-center p-1 overflow-clip"
            style={{ width: "150px", height: "150px" }}
          >
            <div
              className="rounded-full border-3 border-yellow-400 border-dotted flex justify-center items-center"
