  ...
  return (    
    <section className="pb-10 flex justify-end items-center flex-col relative" style={{ height: "100svh", overflow:"hidden" }}>
      ...
      <div className="relative z-10">
        <motion.h1 className={`${abril.className} p-3 text-6xl text-slate-100 custom-shadow text-center`} style={{ lineHeight: "normal" }} variants={header.text01} initial="hidden" whileInView="visible">
          Citlali<br /> & <br />Daniel
        </motion.h1>
        <motion.h2 className={`${greatVibes.className} p-3 text-6xl text-slate-100 custom-shadow`} variants={header.text02} initial="hidden" whileInView="visible">
          Nuestra Boda
        </motion.h2>
        <motion.div className={`${greatVibes.className} mb-3 pb-3 text-slate-100 custom-shadow flex items-center justify-center`} variants={header.timer} initial="hidden" whileInView="visible">
          {/* Temporizador */}
