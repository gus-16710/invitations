...
import { greatVibes, notoSans, playFair } from "./Fonts";
      ...
      <motion.div>
        ...
        >
          ...
          <div className="flex items-center">
            ...
            <label
              className={`${greatVibes.className} py-2 px-6 border-l-2 border-r-2 border-gray-300 text-6xl`}
            >
              14
            </label>
            <label
        ...
        <motion.p
          ...
          viewport={{ once: false }} // Repite la animación
        >
          Daremos el “sí acepto”, seguiremos este emocionante viaje juntos y nos
          encantaría que nos acompañes a celebrar la gran fiesta de nuestra
          boda, llena de brindis, carcajadas y bailes hasta el amanecer.
        </motion.p>
