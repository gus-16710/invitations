...
export default function Gifts() {
  ...
  return (
    <>
      <section
        className="snap-center bg-[url('/img/bodas/diana-ernesto/background-gifts2.jpg')] bg-center bg-cover bg-fixed flex items-center justify-center flex-col text-zinc-900"
        style={{ height: "100svh" }}
      >
        <motion.h1
