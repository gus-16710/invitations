...
export default function Gifts() {
  ...
  return (
    <>
      <section className="bg-[url('/img/bodas/diana-ernesto/background-gifts2.jpg')] bg-center bg-cover bg-fixed h-screen flex items-center justify-center flex-col text-zinc-900">
        <motion.h1
