...
export default function Header() {
  ...
  return (
    <section
      className="h-screen snap-start pb-10 bg-[url('/img/bodas/diana-ernesto/background-section-one.jpg')] bg-cover bg-center flex justify-end items-center flex-col"      
    >
      <motion.h1
