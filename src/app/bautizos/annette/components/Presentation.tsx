...
export default function Presentation() {
  ...
  return (
    <section style={{ backgroundColor: "#e9d4cf" }}>
      <div className="max-w-3xl m-auto relative h-screen flex justify-center items-center flex-col">
        <motion.h1
        ...
        <div className="flex gap-16 text-zinc-600 mt-10">
          ...
          >
            ...
            <p className="flex flex-col items-center mt-5">
              <span
                className={`${anton.className} text-5xl`}
                ref={scopeMinutes}
              >
        ...
        <motion.p
          ...
          whileInView="visible"
        >
          Mientras pasan los días y creces, más seguros estamos que el día en
          que Dios te diseño, quiso bendecirnos. Preciosa e inocente pedimos a
          nuestro señor que acompañe eternamente tus pasitos.
        </motion.p>
