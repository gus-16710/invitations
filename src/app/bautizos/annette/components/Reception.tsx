...
import { big, habibi, rivage, textme } from "./Fonts";
    ...
    >
      <ModalContent>
        {(onClose) => (
          <>
            <ModalHeader
              className={`${rivage.className} flex flex-col gap-1 items-center text-3xl`}
            >
              Recepción
            </ModalHeader>
            <ModalBody>
    ...
    <section className="relative">
      <div className="h-screen flex justify-center items-center flex-col">
        <motion.h1
          ...
          variants={reception.animationText01}
          initial="hidden"
          whileInView="visible"
        >
          Recepción
        ...
        <motion.svg
          ...
          xmlSpace="preserve"
          style={{ fill: "#b8965e" }}
          variants={reception.animationDivider}
          initial="hidden"
          whileInView="visible"
        >
          <g>
        ...
        <motion.div
          ...
          variants={reception.animationCard}
          initial="hidden"
          whileInView="visible"
        >
          <div
          ...
          >
            <Image
              ...
              width={300}
              height={300}
              src={"/img/bautizos/annette/salon.jpg"}
              priority
            />
          </div>
          <p
            className={`${big.className} mt-10 flex items-center justify-center gap-1 text-orange-900 text-lg`}
          >
            <FaRegCalendarAlt className="mb-1" /> 07 DE JULIO ~ 15:00 HRS
          </p>

          <p
            className={`${habibi.className} mx-10 mt-5 text-center text-orange-900`}
          >
            Salones "Aurora"
          </p>
          <p
            className={`${textme.className} text-center mt-3 text-sm text-zinc-600`}
          >
          ...
          <div className="flex items-center justify-center mt-10">
            <button
              type="button"
              className="flex items-center justify-center gap-1 text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
              onClick={() => {
                onOpen();
              }}
            >
