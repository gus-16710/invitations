...
export default function Confirm() {
  return (
    <section style={{ backgroundColor: "#e9d4cf" }}>
      <div className="max-w-3xl m-auto h-screen flex flex-col justify-center items-center">
        <motion.h1
          className={`${rivage.className} pt-20 mx-5 text-5xl text-orange-900 text-center`}
        ...
        <motion.svg
          ...
          xmlSpace="preserve"
          style={{ fill: "#b8965e" }}
          variants={confirm.animationDivider}
          initial="hidden"
          whileInView="visible"
        >
          <g>
        ...
        <motion.p
          className={`${playFair.className} text-base px-5 mt-5 text-center text-orange-900`}
        ...
        <motion.p
          className={`${playFair.className} text-base px-5 mt-5 text-center text-orange-900`}
          variants={confirm.animationText04}
          initial="hidden"
          whileInView="visible"
        >
          ¡Muchas Gracias!
        ...
        <div className="mt-5 flex items-center justify-center flex-col">
          <motion.button
            type="button"
            className="flex justify-center items-center gap-2 w-60 mt-3 text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
            onClick={() => window.open("https://wa.link/mv18ux", "_blank")}
            variants={confirm.animationButton01}
            initial="hidden"
            whileInView="visible"
          >
          ...
          <motion.button
            ...
            variants={confirm.animationButton02}
            initial="hidden"
            whileInView="visible"
          >
