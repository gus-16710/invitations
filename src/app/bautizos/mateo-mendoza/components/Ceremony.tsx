...
const MapCeremony = () => (
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3776.8258442370175!2d-97.0985547!3d18.805913099999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c5027a2bd17f0f%3A0x923cb0ecbf52a73a!2sParroquia%20de%20Santiago%20Ap%C3%B3stol!5e0!3m2!1ses!2smx!4v1763586110433!5m2!1ses!2smx"
    height="450"
    style={{ border: "0" }}
    allowFullScreen
    loading="lazy"
    ...
    <>
      ...
      >
        ...
        <Avatar
          isBordered
          color="default"
          src="/img/bautizos/mateo-mendoza/church2.jpg"
          className="h-44 w-44 my-5 shadow-lg"
        />

        <span className="flex items-center justify-center gap-1 bg-pink-100 text-pink-800 text-xl font-medium me-2 px-2.5 py-0.5 rounded  border border-pink-400">
          <IoMdTime /> 12:00 HRS
        </span>
        ...
        >
          Av Miguel Hidalgo Nte 21, 94860 Tlilapan, Ver.
        </p>
