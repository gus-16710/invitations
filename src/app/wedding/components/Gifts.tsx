...
export default function Gifts() {
  ...
  return (
    <>
      <section className="bg-[url('/img/wedding/background-gifts2.jpg')] bg-center bg-cover bg-fixed h-screen flex items-center justify-center flex-col text-zinc-900">
        <motion.h1
            ...
            <CardBody>
              <div className="flex items-start justify-start">
                <Image
                  ...
                  shadow="md"
                  src="/img/wedding/liverpool-logo.png"
                  width="40px"
                />
            ...
            <CardBody>
              <div className="flex items-start justify-start">
                <Image
                  ...
                  className="object-cover"
                  shadow="md"
                  src="/img/wedding/amazon-logo.png"
                  width="40px"
                />
                <div className="flex items-center justify-center h-full ml-5 mt-2">
            ...
            <CardBody>
              <div className="flex items-start justify-start">
                <Image
                  ...
                  className="object-cover"
                  shadow="md"
                  src="/img/wedding/sears-logo.png"
                  width="40px"
                />
                <div className="flex items-center justify-center h-full ml-5 mt-2">
            ...
            <CardBody>
              <div className="flex items-start justify-start">
                <Image
                  ...
                  className="object-cover"
                  shadow="md"
                  src="/img/wedding/credit-logo.png"
                  width="40px"
                />
                <div className="flex items-center justify-center h-full ml-5 mt-2">
                  <h3 className="font-semibold text-foreground/90">
