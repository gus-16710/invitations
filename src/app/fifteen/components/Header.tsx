  ...
  return (
    ...
    >
      ...
      <div className="relative h-72 w-72 flex items-center justify-center mt-5">
        <motion.div
          className="bg-[url('/img/fifteen/fifteen-girl.jpg')] bg-contain bg-no-repeat bg-center absolute w-60 h-60 rounded-full mb-2"
          variants={animation01}
          initial="hidden"
          whileInView="visible"
        />
        <motion.div
          className="bg-[url('/img/fifteen/header-03.png')] bg-contain bg-no-repeat bg-center absolute w-full h-full"
      ...
      <motion.div
        className="bg-[url('/img/fifteen/header-01.png')] bg-cover bg-bottom absolute inset-0 z-0"
      ...
      />
      <motion.div
        className="bg-[url('/img/fifteen/header-02.png')] bg-cover bg-bottom absolute inset-0 z-10"
        variants={animation05}
        initial="hidden"
        whileInView="visible"
