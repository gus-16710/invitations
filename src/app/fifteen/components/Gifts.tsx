  ...
  return (
    <>
      ...
      >
          ...
          <CardBody className="flex items-center justify-center flex-col">
            ...
            >
              <div className="flex items-center justify-center flex-col w-20">
                <Avatar
                  src="/img/fifteen/liverpool-logo.png"
                  isBordered
                  onClick={() =>
                    openLink("https://mesaderegalos.liverpool.com.mx/")
                  }
                />
                <Link
                  color="warning"
              ...
              <div className="flex items-center justify-center flex-col w-20">
                <Avatar
                  src="/img/fifteen/amazon-logo.png"
                  isBordered
                  onClick={() =>
                    openLink("https://www.amazon.com.mx/registries")
                  }
                />
                <Link
                  color="warning"
            ...
            >
              <div className="flex items-center justify-center flex-col w-20">
                <Avatar
                  src="/img/fifteen/sears-logo.png"
                  isBordered
                  onClick={() =>
                    openLink("https://www.sears.com.mx/Mesa-de-Regalos/")
                  }
                />
                <Link
                  color="warning"
              ...
              <div className="flex items-center justify-center flex-col w-20">
                <Avatar
                  src="/img/fifteen/credit-logo.png"
                  isBordered
                  onClick={() => onOpen()}
                />
                <Link
        ...
        <motion.img
          src="/img/fifteen/floral-right02.png"
          width={250}
          height={250}
          alt=""
        ...
        />
        <motion.img
          src="/img/fifteen/floral-left02.png"
          width={200}
          height={200}
          alt=""
